...
class CourseQuestionAnswer extends Model {
	 ...
	 * @var string
	 */
	protected $object_type = 'course_qa';
	 ...
	 * @var string
	 */
	protected $cache_group = 'course_qas';
	 ...
	 * @since 0.1.0
	 *
	 * @param CourseQuestionAnswerRepository $course_qa_repository Course Review Repository.
	 */
	public function __construct( CourseQuestionAnswerRepository $course_qa_repository ) {
		$this->repository = $course_qa_repository;
	}
