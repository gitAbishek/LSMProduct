...
<p class="email-template--info">
	<?php
		printf(
			...
			esc_html__( 'Thanks for creating an account on %1$s. You can access your account area and view your courses, account details, and more from %2$s', 'masteriyo' ),
			wp_kses_post( make_clickable( get_home_url() ) ),
