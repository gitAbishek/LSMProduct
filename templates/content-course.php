...
<div class="mto-group course-card mto-max-h-429 mto-overflow-hidden">
	<div class="mto-relative">
		...
		<img class="mto-w-full" src="https://via.placeholder.com/150" alt="You are your only limit">
	</div>
	<!-- Hidden Card -->
	<div class="course-author-detail mto-opacity-0 group-hover:mto-opacity-100 mto-transition-opacity mto-absolute group-hover:mto-top-0 group-hover:mto-bottom-0 mto-flex-col mto-justify-between mto-bg-primary">
		<div class="mto-px-4 mto-py-4">
			...
			<div class="course-author-detail">
				...
				<a href="#" class="course-author-readmore">Read More</a>
			</div>
		</div>
		<div class="course-time-share mto-border mto-border-opacity-10">
	...
	<div class="course-detail mto-bg-white mto-px-4 mto-py-4 mto-w-full">
		...
		<h2 class="mto-font-bold mto-text-base mto-capitalize mb-2">
			<?php echo esc_html( $course->get_name() ); ?>
		</h2>
		<div class="course-time-share mto-mt-4">
			...
			<div class="course-enroll">
				<a href="#" class="hover:mto-bg-primary-700 mto-transition mto-delay-150 mto-duration-300 mto-ease-in-out focus:mto-outline-none">
