 ...
 * @package Masteriyo\Emails
 */
class OrderOnHoldEmail extends Email {
	/**
	 * Email method ID.
	 *
	 * @since 0.1.0
	 ...
	 * @var String
	 */
	protected $id = 'order_onhold_email';
	 ...
	 * @var string
	 */
	protected $setting_name_for_enable = 'onhold_order_enable';
	 ...
	 * @var string
	 */
	protected $setting_name_for_subject = 'onhold_order_subject';
	 ...
	 * @var string
	 */
	protected $setting_name_for_heading = 'onhold_order_heading';
	 ...
	 * @var string
	 */
	protected $setting_name_for_content = 'onhold_order_content';
	 ...
	 * @var string
	 */
	public $html_template = 'emails/order-on-hold.php';
	...
	public function get_default_subject() {
		return __( 'Order on hold — {site_title}', 'masteriyo' );
	}
	...
	public function get_default_heading() {
		return __( 'Order on hold', 'masteriyo' );
	}
