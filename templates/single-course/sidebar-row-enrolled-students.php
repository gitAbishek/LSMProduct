<?php
/**
 * Sidebar row - Enrolled students count.
 *
 * @version 0.1.0
 */
...
<div class="mto-scourse--enroll mto-scourse--mdetail mto-icon-svg mto-flex">
	...
	<span>
		...
		<?php printf( esc_html__( '%d Student(s) Enrolled', 'masteriyo' ), esc_html( $enrolled_users_count ) ); ?>
	</span>
</div>
