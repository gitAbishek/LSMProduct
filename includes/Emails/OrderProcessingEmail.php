 ...
 * @package ThemeGrill\Masteriyo\Emails
 */
class OrderProcessingEmail extends Email {
	/**
	 * Email method ID.
	 *
	 * @since 0.1.0
	 ...
	 * @var String
	 */
	protected $id = 'order_processing_email';
	 ...
	 * @var string
	 */
	protected $setting_name_for_subject = 'processing_order_subject';
	 ...
	 * @var string
	 */
	protected $setting_name_for_heading = 'processing_order_heading';
	 ...
	 * @var string
	 */
	protected $setting_name_for_content = 'processing_order_content';
	 ...
	 * @var string
	 */
	public $html_template = 'emails/order-processing.php';
	...
	public function get_default_subject() {
		return __( 'Order in processing — {site_title}', 'masteriyo' );
	}
	...
	public function get_default_heading() {
		return __( 'Order in processing', 'masteriyo' );
	}
