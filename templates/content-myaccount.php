...
<div class="mto-flex mto-flex-col md:mto-flex-row">
	...
	<div id="vertical-menu" class="mto-flex-none mto-fixed mto-inset-0 mto--ml-9999 md:mto-ml-0 mto-h-screen mto-w-4/5 mto-shadow-2xl md:mto-shadow-none mto-bg-white mto-z-50 md:mto-flex md:mto-w-72 md:mto-sticky md:mto-top-0">
		<?php
