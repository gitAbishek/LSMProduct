...
<div class="mto-feature-img">
	...
	<?php if (empty($course->get_featured_image_url())) : ?>
		<img class="mto-w-full mto-feature-course-image" src="https://via.placeholder.com/150" alt="Course featured image">
	<?php else : ?>
		<img class="mto-w-full mto-feature-course-image" src="<?php echo $course->get_featured_image_url(); ?>" alt="Course featured image">
	<?php endif; ?>
