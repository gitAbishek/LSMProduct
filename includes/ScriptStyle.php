	...
	private static function init_scripts() {
		...
		self::$scripts = apply_filters(
			...
			array(
				...
				'single-course' => array(
					'src'      => self::get_asset_url( "/assets/js/build/frontend/single-course{$suffix}.js" ),
					'deps'     => array( 'jquery' ),
					'context'  => 'public',
					'callback' => 'masteriyo_is_single_course_page',
				),
				'edit-account'  => array(
					'src'      => self::get_asset_url( "/assets/js/build/frontend/edit-account{$suffix}.js" ),
					'deps'     => array( 'jquery' ),
				...
				'login-form'    => array(
					'src'      => self::get_asset_url( "/assets/js/build/frontend/login-form{$suffix}.js" ),
					'deps'     => array( 'jquery' ),
					'version'  => self::get_version(),
					'context'  => 'public',
				...
				'checkout'      => array(
					'src'      => self::get_asset_url( "/assets/js/build/frontend/checkout{$suffix}.js" ),
					'deps'     => array( 'jquery' ),
					'version'  => self::get_version(),
					'context'  => 'public',
