...
class Email {
	...
	public function get_additional_content() {
		...
		$content      = masteriyo_get_setting_value( $setting_name, $this->get_default_additional_content() );
	...
	public function get_from_name( $from_name = '' ) {
		$from_name = apply_filters(
			...
			masteriyo_get_setting_value( 'masteriyo_email_from_name', $from_name ),
			$this,
			$from_name
		);
	...
	public function get_from_address( $from_email = '' ) {
		$from_email = apply_filters(
			...
			masteriyo_get_setting_value( 'masteriyo_email_from_address', $from_email ),
			$this,
			$from_email
		);
