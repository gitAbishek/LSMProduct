		...
		<form id="masteriyo-signup--form" class="masteriyo-signup-form" method="post">
			...
			<div class="">
				...
				<div class="masteriyo-password">
					...
					<input id="password" class="masteriyo-input masteriyo-input-password" name="password" type="password" autocomplete="current-password"  value="<?php echo esc_attr( $session->get( 'user-registration.password' ) ); ?>">
				</div>
